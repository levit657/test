...
sys.stdout.write("\x1b]2;\x1b[0;95m FY\x1b[0;92mZ1X\033[01;97m Welcome To Joker\x07")
def modifications():
	print ("Contact prelaxisity on ig as this  Script Is Currently Under Maitnance.")
	on_enter = input("Press Enter To Leave.")
	exit()
#column:65
methods = """
...
\033[0;95m                 ║--------- *Private Property Of @prelaxisity LLC* ------------------  ║
...
af = """
\033[0;95m                                                                     \033[0;95m Made By @prelaxisity
\033[1;31m          \033[01;97m -> |  \x1b[0;95m Main Menu\033[0;97m  | <-    \033[0m
\033[0;95m ╔══════════════════════════════════════╗   \033[0m 
\033[0;95m ║ \x1b[0;95mMETHODS -> \033[97mShows attack commands     \033[0;95m║   \033[0m 
\033[0;95m ║ \x1b[0;95mINFO -> \033[97mShows owner info             \033[0;95m║   \033[0m 
\033[0;95m ║ \x1b[0;92mTOOLS -> \033[97mShows admin commands        \033[0;95m║   \033[0m 
	...
	while True:
		...
		if sinput == "cls":
			...
			try:
				...
				print ("[\x1b[0;95m F1\x1b[0;92mZ1X\033[01;97m] The Command {} Requires An Argument.".format (sinput))
				main()
			except socket.gaierror:
				print ("[\x1b[0;95m FY\x1b[0;92mZ1X\033[01;97m] Host: {} Invalid".format (host))
				main()
...
try:
	...
	if user == "root":
		if password == passwords[0]:
			...
			print ("[*] Sorry to hear you wanna exit.")
                    print ("[*] we are now Exiting you out of FYZ1 net made by @prelaxisity")
			exit()
	if user == "root":
		if password == passwords[1]:
			...
			print ("[*] Sorry but something you did was not correct.")
                    print ("[*] we are now Exiting you out of FYZ1 net made by @prelaxisity")
			exit()
except KeyboardInterrupt:
	exit
